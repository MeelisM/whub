...
const getPlayerStats = async function (req, res) {
  try {
    ...
    const playerGeneralStatsResponse = await axios.get(
      playerGeneralStatsRequest
    );
    ...
    const overallWn8 = await wn8Results.reduce(
    ...
    const playerProfile = {
      ...
      playerInfo: {
        ...
        globalRating:
          playerGeneralStatsResponse.data.data[playerId].global_rating,
        spotsTotal:
          playerGeneralStatsResponse.data.data[playerId].statistics.all.spotted,
        spotsAvg: (
          playerGeneralStatsResponse.data.data[playerId].statistics.all
            .spotted /
        ...
        assistedAverage:
          playerGeneralStatsResponse.data.data[playerId].statistics.all
            .avg_damage_assisted,
        hitsTotal:
          playerGeneralStatsResponse.data.data[playerId].statistics.all.hits,
        hitsPercent:
          playerGeneralStatsResponse.data.data[playerId].statistics.all
            .hits_percents,
        xpAverage:
          playerGeneralStatsResponse.data.data[playerId].statistics.all.avg_xp,
        xpMax:
          playerGeneralStatsResponse.data.data[playerId].statistics.all.max_xp,
        xpTotal:
          playerGeneralStatsResponse.data.data[playerId].statistics.all.xp,
        blockedAverage:
          playerGeneralStatsResponse.data.data[playerId].statistics.all
            .avg_damage_blocked,
        capturePoints:
        ...
        wins: playerGeneralStatsResponse.data.data[playerId].statistics.all
          .wins,
        losses:
        ...
        lastBattle:
          playerGeneralStatsResponse.data.data[playerId].last_battle_time,
        createdAt: playerGeneralStatsResponse.data.data[playerId].created_at,
        treesCut:
          playerGeneralStatsResponse.data.data[playerId].statistics.trees_cut,
      },
    };
